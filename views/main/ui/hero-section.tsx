    ...
    <section className="relative z-10 px-6 py-16 md:py-24 md:px-12 lg:px-20 overflow-hidden" aria-label="영어 학습 소개">
      ...
      <div className="relative max-w-7xl mx-auto">
        <div className="max-w-3xl">
          {/* Badge */}
          <div
            className={cn("inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/70 backdrop-blur-sm border border-purple-200 shadow-sm mb-8", heroAnimClass())}
          >
          ...
          {/* Headline */}
          <h2
            className={cn("text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6", heroAnimClass("0.1s"))}
          >
          ...
          {/* Subheadline */}
          <p
            className={cn("text-lg md:text-xl text-purple-800/80 leading-relaxed mb-10 max-w-xl", heroAnimClass("0.2s"))}
          >
          ...
          {/* CTA Buttons */}
          <div
            className={cn("flex flex-wrap gap-4 mb-14", heroAnimClass("0.3s"))}
          >
            {!diagnosisCompleted && (
