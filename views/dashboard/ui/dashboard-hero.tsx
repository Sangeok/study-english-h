...
export function DashboardHero({
  ...
  return (
    <div className="grid lg:grid-cols-3 gap-5 mb-5">
      ...
      <div
        className="lg:col-span-2 relative overflow-hidden rounded-[28px] border-2 border-teal-edge bg-teal p-8 text-white"
        style={{
          boxShadow:
            "0 6px 0 0 var(--teal-edge), 0 28px 44px -26px rgba(18,184,134,0.75)",
        }}
      >
        ...
        <div className="relative">
          ...
          <div className="flex flex-wrap items-end gap-5">
            ...
            <div className="mb-1 flex gap-3">
              <div className="rounded-2xl border-2 border-white/25 bg-white/15 px-4 py-2">
      ...
      <div className="tactile-card tactile-card--raised flex flex-col justify-between p-6">
        <div>
          <div className="tactile-tile mb-3 h-12 w-12 border-gold bg-gold-tint text-2xl">
            <span>🎯</span>
          </div>
